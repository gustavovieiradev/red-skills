...
import { evaluateDrainBudget, type DrainBudgetStatus, type ElasticResizeRequest, type ElasticShrinkMode, type SupervisorConfig } from "./config.js";
import { freshSlot, type SlotState, type SpawnPolicy, type SupervisorDeps, type SupervisorState } from "./types.js";
...
export async function retireSlotAt(
  state: SupervisorState,
  index: number,
  result: TickResult,
): Promise<void> {
