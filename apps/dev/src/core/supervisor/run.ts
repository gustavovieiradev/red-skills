...
import type { HeartbeatSlotPid, SupervisorDeps, SupervisorState } from "./types.js";
import { emitSupervisorEvent } from "./events.js";
import { readDrainBudget, logDrainBudgetTransition, spawnSlotForBudget } from "./budget-resize.js";
