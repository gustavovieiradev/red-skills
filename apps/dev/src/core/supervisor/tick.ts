...
import type { SupervisorDeps, TrunkFreshnessOutcome } from "./contracts.js";
import { emitSupervisorEvent, type SupervisorState } from "./state.js";
import type { TickResult } from "./tick-result.js";
import { reconcileDeadWorkerClaim } from "./envelopes.js";
import { dispatchReconcileIfPossible, handleDeadSlot, pollStallDetector, resolveReapContest, terminateAll } from "./lifecycle.js";
import { applyRunnerDirective, growFleetToTarget, logDrainBudgetTransition, readDrainBudget, resolveElasticResize, retireDrainedSlots, shrinkFleetToTarget, spawnPolicyForBudget, spawnSlotForBudget } from "./budget.js";
