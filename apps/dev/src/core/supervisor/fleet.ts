...
import { evaluateDrainBudget, recordDeath, validateStallThresholds, validateSupervisorProgressThreshold, validateSupervisorStaleThreshold, type DrainBudgetStatus, type ElasticResizeRequest, type ElasticShrinkMode, type SupervisorConfig } from "./config.js";
import { reconcileDeadWorkerClaim } from "./envelopes.js";
import { emitSupervisorEvent } from "./events.js";
import { HEARTBEAT_STATE_REPAIR_AFTER_TICKS, emitFleetHeartbeat, superviseHeartbeatStateWrite, trunkFreshnessEventPayload, type TickResult } from "./heartbeat.js";
import { pollStallDetector, resolveReapContest, sweepParkedSlot } from "./slot-recovery.js";
import { freshSlot, type HeartbeatSlotPid, type ReconcileCandidate, type SlotState, type SpawnPolicy, type SupervisorDeps, type SupervisorState, type TrunkFreshnessOutcome, type TrunkMirrorRefreshResult } from "./runtime.js";
