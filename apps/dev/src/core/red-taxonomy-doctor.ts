...
const DURABLE_TMP_TARGETS = new Map<string, { target: string; owner: string }>([
  ["afk-supervisor.state.json", { target: ".red/state/castle/supervisors/fleet/state.toon", owner: "dev/AFK" }],
  ["afk-supervisor.pid", { target: ".red/tmp/supervisors/fleet/afk-supervisor.pid", owner: "dev/AFK" }],
  ["afk-supervisor.stop", { target: ".red/tmp/supervisors/fleet/afk-supervisor.stop", owner: "dev/AFK" }],
  ["afk-supervisor.restarts.json", { target: ".red/tmp/supervisors/fleet/restarts.toon", owner: "dev/AFK" }],
  ["monitor-log-cursors.json", { target: ".red/tmp/monitors/default/log-cursors.toon", owner: "dev/AFK" }],
