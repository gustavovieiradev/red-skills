...
import { runModeForCandidate, type SessionContext, type SessionIssueTemplate, type SelectionFilter, type IssueCandidate } from "../../core/session.js";
...
import { toMemoryPayload, resolveMemoryCli, type AttemptRecordPayload } from "../../core/attempt-record.js";
import { isRunner, type Runner } from "../../types/runner.js";
import { afkPaths, collectPrecheckFacts, collectBootOptions, collectMonitorInputs, buildBootDeps, buildMinimalBootDeps, makeRunAgent, resolveRepoContext, resolveRunSettings, type RepoContext, type AfkPaths } from "../../runtime/wire.js";
...
import { classifyIssue, resolveReviewGate, type IssueClassificationMetadata } from "../../core/issue-classifier.js";
...
import { castleWorktreeUnder, decodeLocMemoSnapshot, encodeLocMemoSnapshot } from "./circuit.js";
