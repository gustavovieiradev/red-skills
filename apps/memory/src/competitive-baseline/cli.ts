...
export async function runCompetitiveBaselineCli(): Promise<void> {
...
export function isCompetitiveBaselineEntrypoint(metaUrl: string, entrypoint = process.argv[1]): boolean {
