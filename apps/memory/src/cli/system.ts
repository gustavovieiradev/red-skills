 ...
 */
export async function resolveOverviewContract(
  args: ParsedArgs,
  rootDir: string,
 ...
 */
export async function runHook(args: ParsedArgs): Promise<void> {
 ...
 */
export async function runVcs(args: ParsedArgs): Promise<void> {
...
export async function resolveHooksDir(rootDir: string): Promise<string> {
  try {
...
export async function runAttempt(args: ParsedArgs): Promise<void> {
...
export async function runAttemptLearn(args: ParsedArgs): Promise<void> {
...
export async function runAttemptLearnApply(args: ParsedArgs): Promise<void> {
